...
public class Main {
    ...
    static void compareSort(Integer[] arr) {
        ...
        SortTestHelper.testSort("com.issac.algo.SelectionSort2", arr2);
        SortTestHelper.testSort("com.issac.algo.BubbleSort", arr3);
        SortTestHelper.testSort("com.issac.algo.ShellSort", arr4);
    }
}
