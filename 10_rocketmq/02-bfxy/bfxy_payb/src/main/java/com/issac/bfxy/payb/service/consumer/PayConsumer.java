...
import com.issac.bfxy.payb.mapper.PlatformAccountMapper;
    ...
    class MessageListenerConcurrently4Pay implements MessageListenerConcurrently {
        ...
        public ConsumeConcurrentlyStatus consumeMessage(List<MessageExt> msgs, ConsumeConcurrentlyContext context) {
            ...
            try {
                ...
                if (paramsBody.get("money") instanceof Integer) {
                    money = new BigDecimal((Integer) paramsBody.get("money"));
                } else {
                    money = (BigDecimal) paramsBody.get("money");    //	当前的收益款
                }
