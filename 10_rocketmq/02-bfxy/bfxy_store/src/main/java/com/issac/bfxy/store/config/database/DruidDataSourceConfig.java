package com.issac.bfxy.store.config.database;
...
public class DruidDataSourceConfig {
    ...
    public FilterRegistrationBean filterRegistrationBean() {
        ...
        log.info("druid filter reg:{}",filterRegistrationBean);
    ...
    public DataSource dataSource() throws SQLException {
        ...
        ds.setConnectProperties(druidSettings.getConnectionProperties());
